    ...
    IDragHandler
{
    ...
    public event UIEventProxy OnUpdateDown;
    ...
    private void Start()
    {
        ...
        C_Texts = GameUtil.GetComponentsInPrefixChildren<Text>(transform,"C_");
        C_Images = GameUtil.GetComponentsInPrefixChildren<Image>(transform,"C_");
